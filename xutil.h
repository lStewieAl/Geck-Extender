...
namespace XUtil
{
	...
	uintptr_t FindPattern(uintptr_t StartAddress, uintptr_t MaxSize, const byte *Bytes, const char *Mask);
	void PatchMemory(uintptr_t Address, byte *Data, size_t Size);
