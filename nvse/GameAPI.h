...
struct RadioEntry
{
	...
	void			*ptr04;
	UInt32			unk08[7];
	static RadioEntry* GetPipBoyRadio() { return *(RadioEntry**)0x11DD42C; }
}; 
...
public:
	...
	struct FontInfo {
		...
		NiTexturingProperty			* texProperty;	// 00C	in OBSE: NiTexturingProperty			* textureProperty
		...
		Data03C						dat03C;			// 03C
		BSSimpleArray<ButtonIcon>	icons;			// 044
