...
DEFINE_CMD(GetBaseSpellListSpells, Return the array of spells for a SpellList, 0, kParams_OneOptionalActorBase);
DEFINE_CMD(GetBaseSpellListLevSpells, Return the array of leveled spells for a SpellList, 0, kParams_OneOptionalActorBase);
DEFINE_CMD(GetBasePackages, returns an array of packages for an actor base form, 0, kParams_OneOptionalActorBase);
DEFINE_CMD(GetBaseFactions, returns an array of factions to which an actor base form belongs, 0, kParams_OneOptionalActorBase);
DEFINE_CMD(GetBaseRanks, returns an array of faction ranks to which an actor base form belongs, 0, kParams_OneOptionalActorBase);
...
DEFINE_CMD(GetHeadParts, returns an array of head parts for a character, 0, kParams_OneOptionalActor);
